...
//Refer to ReadMe.txt file for reference first.
...
#if defined(_WIN32) && ! defined (__MINGW32__) // 64 byte1 integer under Windows 
typedef unsigned __int64   U64;
typedef __int64            I64;
#else                                          // 64 byte1 integer elsewhere ... 
...
#if defined(WIN32)            // 64 byte1 unsigned int constant under Windows 
#define U32_MAX_PLUS_ONE   0x0000000100000000    // 4294967296
#else                         // 64 byte1 unsigned int constant elsewhere ... 
