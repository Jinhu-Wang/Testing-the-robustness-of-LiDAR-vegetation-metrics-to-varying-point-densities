...
{
public:
  ByteStreamInIstreamLE(std::istream& stream);
...
{
public:
  ByteStreamInIstreamBE(std::istream & stream);
/* read 16 bit low-endian field                              */
  void get16bitsLE(U8* bytes);
/* read 32 bit low-endian field                              */
  void get32bitsLE(U8* bytes);
...
inline ByteStreamInIstream::ByteStreamInIstream(std::istream& stream_param) :
  stream(stream_param)
{
}
...
{
  return !!(static_cast<std::ifstream&>(stream));
}
...
inline ByteStreamInIstreamLE::ByteStreamInIstreamLE(std::istream& stream) : ByteStreamInIstream(stream)
{
}
...
inline ByteStreamInIstreamBE::ByteStreamInIstreamBE(std::istream& stream) : ByteStreamInIstream(stream)
{
}
