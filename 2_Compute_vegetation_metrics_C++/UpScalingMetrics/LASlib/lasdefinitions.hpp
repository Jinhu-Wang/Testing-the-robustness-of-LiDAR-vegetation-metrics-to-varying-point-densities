...
#define LAS_TOOLS_VERSION 170915
...
{
public:
  CHAR file_signature[4];                  // starts at byte1   0
  U16 file_source_ID;                      // starts at byte1   4
  U16 global_encoding;                     // starts at byte1   6
  U32 project_ID_GUID_data_1;              // starts at byte1   8
  U16 project_ID_GUID_data_2;              // starts at byte1  12
  U16 project_ID_GUID_data_3;              // starts at byte1  14
  U8 project_ID_GUID_data_4[8];            // starts at byte1  16
  U8 version_major;                        // starts at byte1  24
  U8 version_minor;                        // starts at byte1  25
  CHAR system_identifier[32];              // starts at byte1  26
  CHAR generating_software[32];            // starts at byte1  58
  U16 file_creation_day;                   // starts at byte1  90
  U16 file_creation_year;                  // starts at byte1  92
  U16 header_size;                         // starts at byte1  94
  U32 offset_to_point_data;                // starts at byte1  96
  U32 number_of_variable_length_records;   // starts at byte1 100
  U8 point_data_format;                    // starts at byte1 104
  U16 point_data_record_length;            // starts at byte1 105
  U32 number_of_point_records;             // starts at byte1 107
  U32 number_of_points_by_return[5];       // starts at byte1 111
  F64 max_x;
  F64 min_x;
  F64 max_y;
  F64 min_y;
